...
def test_default_k_is_three():
    # The default moved from 1 (Gamera parity) to 3 — majority vote
    # over the three nearest neighbours is the current design. The
    # k=1 fast path is still supported via explicit construction.
    assert DEFAULT_K == 3
